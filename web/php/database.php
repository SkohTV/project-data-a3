<?php
  ...
  function dbAddPoint_donnee($db, $base_date_time, $mmsi, $latitude, $longitude, $sog, $cog, $heading, $status_code, $draft, $id_cluster) {
    try
    {
      ...
      $request = 'INSERT INTO point_donnee (base_date_time, mmsi, latitude, longitude, speed_over_ground, cap_over_ground, heading, code_status, draft, id_cluster) VALUES (:base_date_time, :mmsi, :latitude, :longitude, :sog, :cog, :heading, :status_code, :draft, :id_cluster)';
      $statement = $db->prepare($request);
