...
Utilisation:
    ...
    python vessel_prediction.py --predict --mmsi 205776000
        ...
        models = {
            ...
            'CatBoost': {
                'model': cb.CatBoostClassifier(
                    random_state=42,
                    verbose=False,
                    auto_class_weights='Balanced'  # CORRECTION: auto_class_weights au lieu de class_weights
                ),
                'params': {
...
def main():
    ...
    # Fichiers de données
    parser.add_argument('--features-file', default='/home/mkkuu/Documents/project-data-a3/ia/data/features_completes.csv',
                       help='Fichier des features (défaut: /home/mkkuu/Documents/project-data-a3/ia/data/features_completes.csv)')
    parser.add_argument('--raw-data-file', default='/home/mkkuu/Documents/project-data-a3/ia/data/export_IA_final.csv',
                       help='Fichier des données brutes (/home/mkkuu/Documents/project-data-a3/ia/data/export_IA_final.csv)')
    parser.add_argument('--model-file', default='/home/mkkuu/Documents/project-data-a3/ia/data/vessel_model.pkl',
                       help='Fichier du modèle (défaut: /home/mkkuu/Documents/project-data-a3/ia/data/vessel_model.pkl)')
